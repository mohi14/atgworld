                    ...
                    <div class="card position-static">
                        ...
                        <div class="card-body">
                            ...
                            <div className='d-flex align-items-center justify-content-between'>
                                <h4 class="card-title mt-3 fw-semibold">What if famous brands had regular fonts? Meet RegulaBrands!</h4>
                                <div>
                            ...
                            <div className='d-flex align-items-center justify-content-between'>
                                <div className='d-flex align-items-center'>
                                    ...
                                    <p className='fw-semibold fs-5  ms-2 mt-3'>Sarthak Kamra</p>
                                </div>
                                <div className='d-flex align-items-center'>
                                    <div className='me-5'>
                                        <img src={require('../../Assets/views.png')} alt="" />
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div className='d-flex align-items-center justify-content-between'>
                                <div className='d-flex align-items-center'>
                                    ...
                                    <p className='fw-semibold fs-5  ms-2 mt-3'>Sarah West</p>
                                </div>
                                <div className='d-flex align-items-center'>
                                    <div className='me-5'>
                                        <img src={require('../../Assets/views.png')} alt="" />
                        ...
                        <div class="card-body">
                            ...
                            <div className='d-flex align-items-center justify-content-between'>
                                <div className='d-flex align-items-center'>
                                    ...
                                    <p className='fw-semibold fs-5  ms-2 mt-3'>Ronal Jones</p>
                                </div>
                                <div className='d-flex align-items-center'>
                                    <div className='me-5'>
                                        <img src={require('../../Assets/views.png')} alt="" />
                        ...
                        <div class="card-body">
                            ...
                            <div className='d-flex align-items-center justify-content-between'>
                                <div className='d-flex align-items-center'>
                                    ...
                                    <p className='fw-semibold fs-5  ms-2 mt-3'>Joseph Gray</p>
                                </div>
                                <div className='d-flex align-items-center'>
                                    <div className='me-5'>
                                        <img src={require('../../Assets/views.png')} alt="" />
